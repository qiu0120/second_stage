...
class FullCompetitionNode(FourthStageMixin, FifthStageMixin, CombinedStage1Stage2Node):
    """
    ...
    def __init__(self):
        ...
        self.get_logger().info('FullCompetitionNode ready: P1 -> P2/P3 -> P4 -> P5 in one ROS2 node.')
